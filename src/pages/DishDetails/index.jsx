                  ...
                  <div>
                    <button onClick={ () => quantity > 1 ? setQuantity(quantity - 1) : false}>
                      <svg width="21" height="3" viewBox="0 0 21 3" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M0.394043 1.49997C0.394043 1.03137 0.773923 0.651489 1.24253 0.651489H19.9092C20.3778 0.651489 20.7577 1.03137 20.7577 1.49997C20.7577 1.96858 20.3778 2.34846 19.9092 2.34846H1.24253C0.773923 2.34846 0.394043 1.96858 0.394043 1.49997Z" fill="white"/>
                      </svg>
                    ...
                    <button onClick={ () => quantity < 99 ? setQuantity(quantity + 1) : false}>
                      <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M0.242676 10.4999C0.242676 10.0313 0.622555 9.65145 1.09116 9.65145H19.7578C20.2264 9.65145 20.6063 10.0313 20.6063 10.4999C20.6063 10.9685 20.2264 11.3484 19.7578 11.3484H1.09116C0.622555 11.3484 0.242676 10.9685 0.242676 10.4999Z" fill="white"/>
                        <path fillRule="evenodd" clipRule="evenodd" d="M10.4245 0.318115C10.8931 0.318115 11.273 0.697995 11.273 1.1666V19.8333C11.273 20.3019 10.8931 20.6818 10.4245 20.6818C9.95589 20.6818 9.57601 20.3019 9.57601 19.8333V1.1666C9.57601 0.697995 9.95589 0.318115 10.4245 0.318115Z" fill="white"/>
                      </svg>
                    </button>
                  </div>

                  <button onClick={ addToCart }>
                    <svg width="17.58" height="14.87" viewBox="0 0 27 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    pedir ∙ R$ { (dish.price * quantity).toFixed(2) }
                  </button>
                </div>
              }
            </div>
